...
>(({ className, children, ...props }: React.ComponentPropsWithoutRef<typeof ScrollAreaPrimitive.Root>, ref: React.ForwardedRef<React.ElementRef<typeof ScrollAreaPrimitive.Root>>) => (
