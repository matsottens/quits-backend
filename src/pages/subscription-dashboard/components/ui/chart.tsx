...
type TooltipFormatterCallback = 
  | ((value: any, name: string, props: any) => React.ReactNode)
  | string
  | number
  | ((value: any, name: string, entry: any, index: number) => React.ReactNode);
            ...
            return (
              <div key={key} className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                  {itemConfig?.icon && (
                    <div className="h-4 w-4" style={{ color: indicatorColor }}>
                      <itemConfig.icon />
                    </div>
                  )}
...
function getPayloadConfigFromPayload(
  ...
  return config[key] || config[payload.dataKey as string] || config[payload.name as string]
}
