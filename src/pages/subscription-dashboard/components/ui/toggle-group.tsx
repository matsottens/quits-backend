...
const ToggleGroup = React.forwardRef<
  ...
  ToggleGroupProps
>(({ className, variant, size, children, ...props }: ToggleGroupProps, ref: React.ForwardedRef<React.ElementRef<typeof ToggleGroupPrimitive.Root>>) => (
...
>(({ className, children, variant, size, ...props }: ToggleGroupItemProps, ref: React.ForwardedRef<React.ElementRef<typeof ToggleGroupPrimitive.Item>>) => {
