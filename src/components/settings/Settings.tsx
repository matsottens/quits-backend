        ...
        <div className="bg-white shadow rounded-lg mb-8">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-sm font-medium text-gray-900">Renewal Reminders</h3>
                  <p className="text-sm text-gray-500">Get notified before subscriptions renew</p>
                </div>
                <button
                  type="button"
                  className={`${
                    notifications.renewalReminders ? 'bg-primary' : 'bg-gray-200'
                  } relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2`}
                  onClick={() => handleNotificationChange('renewalReminders')}
                >
                  <span
                    className={`${
                      notifications.renewalReminders ? 'translate-x-5' : 'translate-x-0'
                    } pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out`}
                  />
                </button>
              </div>
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className={`${
                    notifications.priceChangeAlerts ? 'bg-primary' : 'bg-gray-200'
                  } relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2`}
                  onClick={() => handleNotificationChange('priceChangeAlerts')}
                >
                  <span
                    className={`${
                      notifications.priceChangeAlerts ? 'translate-x-5' : 'translate-x-0'
                    } pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out`}
                  />
                </button>
              </div>
